...
export default {
    ...
    methods: {
        ...
        addDic(){
            this.$refs.dicForm.validate(async valid => {
                if (valid) {
...
<!--    removeTeacher, getDictory, saveEdit, saveDic-->
<!--} from '../../api/api'-->
...
<!--        },-->
<!--        saveDicEdit(){-->
<!--            let para = this.dicForm-->
<!--            this.$store.commit('setDiction', this.dicForm.code);-->
<!--            saveDic(para).then((res) => {-->
<!--               console.log(res)-->
